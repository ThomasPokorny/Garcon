...
public class Category extends TableImpl<CategoryRecord> {
    ...
    private static final long serialVersionUID = 142414753;

    /**
     * The reference instance of <code>garcon.category</code>
     */
    ...
    /**
     * The column <code>garcon.category.id</code>.
     */
    public final TableField<CategoryRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('garcon.category_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>garcon.category.name</code>.
     */
    public final TableField<CategoryRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * Create a <code>garcon.category</code> table reference
     */
    public Category() {
    ...
    /**
     * Create an aliased <code>garcon.category</code> table reference
     */
